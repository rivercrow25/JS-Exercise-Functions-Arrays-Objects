...
function makeSmartPerson(name) {
  const person = {
    ...
    speak: function () {
      return `Hello, my name is ${person.name}` // "hellow my name is" + person.name
    }
  }
  return person
}
...
function getCarInfoById(inventory, id) {
  /* code here */
  const identification = inventory[id - 1]
  return `this is a ${identification.car_make} ${identification.car_model}`
}
